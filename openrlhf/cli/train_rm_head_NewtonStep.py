...
from openrlhf.trainer.rm_trainer_head_NewtonStep import RewardModelTrainer
...
def train(args):
    ...
    trainer = RewardModelTrainer(
        ...
        lambda_growth_rate=args.lambda_growth_rate,
        hessian_decay=args.hessian_decay
    )
...
if __name__ == "__main__":
    ...
    # NewtonStep parameters
    parser.add_argument("--lambda_reg", type=float, default=0.1, help="Regularization coefficient")
    parser.add_argument("--lambda_strategy", type=str, choices=["", "constant", "log", "linear", "square", "cosine"], default="",
                        help="Strategy for selecting lambda")
    parser.add_argument("--lambda_growth_rate", type=float, default=5.0,
                        help="Growth rate for lambda strategies.")
    parser.add_argument("--hessian_decay", type=float, default=1.0,
                        help="Decay rate for Hessian accumulation (default: 1.0)")
