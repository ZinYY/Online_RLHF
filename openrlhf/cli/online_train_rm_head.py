...
from openrlhf.trainer.rm_trainer_head import RewardModelTrainer
from openrlhf.utils import blending_online_datasets, get_strategy, get_tokenizer
...
def train(args):
    ...
    train_data, eval_data = blending_online_datasets(
        args.dataset,
        args.dataset_probs,
        strategy,
        args.seed,
