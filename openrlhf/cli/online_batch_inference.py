...
from openrlhf.utils import get_processor, get_strategy, get_tokenizer, blending_online_datasets
...
def batch_generate_vllm(args):
    ...
    prompts_data = blending_online_datasets(
        args.dataset,
        args.dataset_probs,
        dummy_strategy,
        args.seed,
...
def batch_rm_inference(args):
    ...
    dataset = blending_online_datasets(
        args.dataset,
        args.dataset_probs,
        strategy,
        args.seed,
    ...
    if strategy.is_rank_0():
        ...
        print(f"Final Results: Reward mean: {rewards.mean().item()}, std: {rewards.std().item()}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--current_t", type=int, default=0, help="Current iteration")
    parser.add_argument("--total_T", type=int, default=10, help="Total number of iterations")
    parser.add_argument("--t_length", type=int, default=1, help="Length of intervals")
