...
from openrlhf.trainer.rm_active_trainer_head_hvp import RewardModelTrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_select_samples", type=int, default=5000, help="Maximum number of samples for active learning")
    parser.add_argument("--score_type", type=str, default="fisher", help="Type of scoring function to use: fisher, reward_diff, or margin")
